...
const AGENT_CONFIG_DEFAULTS: Array<{ type: string; content: string }> = [
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "Store what you learned in mongoBrain:",
      "",
      "- `mongobrain_store` collection `config` type `identity` — your name, creature, vibe, emoji",
      "- `mongobrain_store` collection `config` type `user` — their name, how to address them, timezone, notes",
      "- `mongobrain_store` collection `config` type `soul` — what matters to them, how they want you to behave, boundaries",
      "",
      "## Connect (Optional)",
      "",
      ...
      "## When You're Done",
      "",
      "You don't need this bootstrap anymore — you're you now.",
    ].join("\n"),
  },
];
